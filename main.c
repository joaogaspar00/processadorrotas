...
***************************/
void heading();
void desalocacao_memoria(LISTA * dados_uteis);
...
int main(){
    ...
    desalocacao_memoria(dados_uteis);
...
/*************************************************************
* Função: void desalocacao_memoria(LISTA * dados_uteis)      *
* Descrição: Recebe o ponteiro da lista e remove cada        *
*       elemento um a um por ordem                           *
**************************************************************/
void desalocacao_memoria(LISTA * dados_uteis){
    LISTA * aux;
    aux = dados_uteis;
    while(aux != NULL){                         /* Varimento da lista */
        dados_uteis = aux->proximo;
        free(aux);                              /* Libertação da memória */
        aux = dados_uteis;
    }
}
/*************************************************************/
...
LISTA * leitura_dados_uteis(){
    ...
    FILE * ficheiro;
    char nome_ficheiro[] = "localidades.txt";
